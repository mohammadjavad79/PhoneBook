...
در این پروژه با استفاده از قواعد DDD و این طر تفکر تلاش کردم تا قسمتهای مختلف پروژه را از همدیگه جدا کرده و هر بخش وظایف خودش را انجام دهد.
---

## معماری پروژه

### ۱. لایه Domain – منطق اصلی کسب‌وکار
لایه **Domain** هسته‌ی اصلی پروژه که تمام قوانین و رفتارهای پروژه در این لایه تعریف شده‌اند.

در این پروژه:

- موجودیت `PhoneBook` به عنوان تفرچه تلفن دیده شده است .
